...
export const CHEAT_SHEETS: CheatSheet[] = [
  ...
  // =========================================================================
  {
    ...
    //     title: 'Set Up',
    //     snippets: [
    //       createSnippet('react-create-app', 'Creating a React App', 'Terminal.', 'npm create vite@latest my-react-app -- -- template react ', 'javascript', ['Basics']),
    //       createSnippet('react-locate-folder', 'Navigate to folder', 'Terminal.', 'cd my-react-app', 'javascript', ['Basics']),
    //       createSnippet('react-install-dependencies', 'Install dependencies', 'Terminal.', 'npm install', 'javascript', ['Basics']),
    //       createSnippet('react-run-server', 'Start the development server', 'Terminal.', 'npm run dev', 'javascript', ['Basic']),
    //     ]
    //   },
      {
        id: 'react-basics',
    ...
    categories: [
      {
        ...
        snippets: [
          createSnippet('tw-install', 'Install', 'npm install.', 'npm install -D tailwindcss postcss autoprefixer\nnpx tailwindcss init -p', 'bash', ['Setup']),
